...
class Table(object):
    def __init__(self, data, limit=None, index=None):
        ...
        self._table = make_table(None, _accessor, None, self._limit,
    ...
    def update(self, data):
        ...
        if (_is_arrow):
            _accessor = data
            self._table = make_table(self._table, _accessor, None, self._limit, self._index, t_op.OP_INSERT, True, True)
        ...
        self._table = make_table(self._table, _accessor, None, self._limit,
    ...
    def remove(self, pkeys):
        ...
        t = make_table(self._table, _accessor, None, self._limit,
